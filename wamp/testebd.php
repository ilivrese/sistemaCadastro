		<?php
          	...
          	$letraounome = $_POST['letraounome'];
          	$caracteres = strlen($letraounome);


            
				$stgsql = "select * from usuarios where LEFT(nome,$caracteres)='$letraounome' ORDER by nome aSC";
...
include "abrelog.php";
$textlog = $headlog."Busca por [".$letraounome."] obteve ".$linhas." resultado(s).\r\n";
...
// criando um arquivo log
include "abrelog.php";
$textlog = $headlog."Nome [".$letraounome."] não encontrado.\r\n";
include "escrevefechalog.php";
// fim da mensagem log

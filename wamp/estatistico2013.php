...
$stgsql = "select idusuario from atendimento where data >= '".$ano."-"."01-01' and
data <= '".$ano."-".($mes-1)."-31' and idusuario is not null";
...
$stgsql2 = "select idusuario from atendimento where data >= '".$ano."-"."01-01' and
data <= '".$ano."-".($mes-1)."-31' and idusuario is not null ORDER by idusuario ASC";
...
atendimento.idusuario = usuarios.idusuario and atendimento.data >= '".$ano."-"."01-01' and
atendimento.data <= '".$ano."-".($mes-1)."-31' and atendimento.idusuario is not null";
$res = mysql_query($stgsql,$conec);
$linhas = mysql_num_rows($res);
...
echo "<h1>Dados estatísticos do ano de ".$ano." (01 de Janeiro a 01 de ".$mesextenso." de ".$ano.")</h1>" ;

echo "<h2>Uso Livre</h2>" ;
echo "<font size='1'><i>Horários de 30 minutos e 1 hora em 14 computadores.</i></font>";
...
echo "<hr>";
echo "<b>Total de Atendimentos do ano:</b> ".$total;
echo "<br>";
echo "<b>Média mensal de atendimentos:</b> ".$total/($mes-1);
echo "<br>";
/*
echo "<b>Total de Usuários do ano:</b> ".$totalefetivo;
echo "<br>";
echo "<b>Média mensal de Usuários do ano:</b> ".$totalefetivo/($mes-1);
echo "<br>";
*/
echo "<hr>";
...
echo "<i>Usuários até 11 anos: </i>".$a;
echo "<br>"  ;
echo "<i>Usuários de 12 a 17 anos: </i>".$b;
echo "<br>"  ;
echo "<i>Usuários de 18 a 34 anos: </i>".$c;
echo "<br>"  ;
echo "<i>Usuários de 35 a 59 anos: </i>".$d;
echo "<br>"  ;
echo "<i>Usuários acima de 60 anos: </i>".$e;
echo "<br>"  ;
echo "<i>Dados insuficientes: </i>".$invalido;
echo "<br>"  ;
...
atendimento.idusuario = usuarios.idusuario and usuarios.nacionalidade = 'brasil'
 and atendimento.data >= '".$ano."-"."01-01' and
atendimento.data <= '".$ano."-".($mes-1)."-31' and atendimento.idusuario is not null";
...
oficinas.datainicio >= '".$ano."-01-01' and
oficinas.datainicio < '".$ano."-".$mes."-01' order by oficinas.datainicio asc";
$res3 = mysql_query($stgsql3,$conec);
$totalpartic = mysql_num_rows($res3);

 echo "<b>Total de participantes em oficinas: </b>".$totalpartic;
 echo "<br>";
  echo "<b>Média mensal de participantes em oficinas: </b>".$totalpartic/($mes-1);
       echo "<br>";
 

$stgsql = "select * from oficinas
where datainicio >= '".$ano."-01-01' and datainicio < '".$ano."-".$mes."-01' order by datainicio asc";
$res = mysql_query($stgsql,$conec);
$linhas = mysql_num_rows($res);
$linhaini =1;
$totalofic = $linhas;
 ...
 echo "<br>";
  echo "<b>Média mensal de oficinas oferecidas: </b>".$totalofic/($mes-1);

    echo "<br>";
  echo "<b>Média mensal de participantes por oficina: </b>".$totalpartic/$totalofic       ;
         echo "<br>";
         echo "<hr>";
...
oficinas.idoficina and oficinas.datainicio >= '".$ano."-01-01' and
oficinas.datainicio < '".$ano."-".$mes."-01'";
...
participantesofic.idusuario = usuarios.idusuario and participantesofic.idoficina =
oficinas.idoficina and usuarios.nacionalidade = 'BRASIL' and oficinas.datainicio >= '".$ano."-01-01' and
oficinas.datainicio < '".$ano."-".$mes."-01'";
...
participantesofic.idusuario = usuarios.idusuario and participantesofic.idoficina =
oficinas.idoficina and usuarios.sexo = 'F' and oficinas.datainicio >= '".$ano."-01-01' and
oficinas.datainicio < '".$ano."-".$mes."-01'";
